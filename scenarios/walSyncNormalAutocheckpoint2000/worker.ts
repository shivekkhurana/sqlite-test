...
/**
 * WAL Sync Normal Autocheckpoint 2000 Worker
 * 
 * Opens database with WAL + synchronous NORMAL + wal_autocheckpoint 2000 (set in setup).
 * Sets busy_timeout = 2000ms and wal_autocheckpoint = 2000 per connection.
 */
